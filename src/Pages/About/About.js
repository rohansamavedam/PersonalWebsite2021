...
function About() {
  return (
      <div style={{marginTop: "60px", paddingBottom: "60px", backgroundColor: userData.theme.themeColor, minHeight: "90vh"}}>
          {/* <div style={{backgroundColor: userData.theme.themeColor, width: "400px", height: "100%", position: "absolute"}}>
          </div> */}
          <Container style={{ display: "block", textAlign:"center", paddingBottom: "10px", height: "auto"}} >
